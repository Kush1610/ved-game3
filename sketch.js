...
function setup() {
 ...
 // doraemon.debug=true
  ...
  gad1=createSprite(width/2+200,height/2+100,20,20);
...
// wall16.debug=true
 ...
 nobita=createSprite(width-100,height/2+300,80,200);
 ...
 gianlev2=createSprite(width/5+60,height/2+300,80,200);
...
if(frameCount % 1870 == 0) 
  {
    gian= createSprite(width/2+700, height/2+245,20,50);
...
if(frameCount % 500== 0) 
  {
    mouse= createSprite(width/2+700, height/2+350,20,50);
...
console.log(gad2.lifetime)
 ...
 if(frameCount % 200=== 0) 
  {
    doracake= createSprite(width/2+800, height/2+350,20,50);
    doracake.y=Math.round(random(height/2,height/2+150));
...
function keyPressed() {
  ...
  if((keyCode === 32)&&(doraemon.y>=height/2+295)&&(GameState===Play)) 
  {
